...
if __name__ == "__main__":
    ...
    model = LitBaseline(vec_size, chord_vocab, conf)
    ...
    trainer = pl.Trainer(
        ...
        max_epochs = conf.training.epoch,
        ...
        callbacks=[CheckpointEveryNEpoch(0, conf.training.save_every_n), early_stop_callback]
    )
